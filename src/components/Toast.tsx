...
export const Toast: React.FC = () => {
  ...
  const [tipoToast, setTipoToast] = useState<"angry" | "motivation" | "break">(
    "motivation",
  );
  ...
  return (
    <div
      id="toast"
      className={`toast ${tipoToast} ${visible ? "show" : "hide"}`}
    >
      <div className="toast-container">
        <div className="toast-content">
          {imagenSrc && (
            <img src={imagenSrc} alt="Toast Image" className="toast-img" />
          )}
        </div>
